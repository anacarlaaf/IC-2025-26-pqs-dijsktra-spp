...
// g++ -O2 -o gen random-graph-generator.cpp
// ./gen <num_vertices> <grau_medio> <peso_max> <seed>
// ./gen 1000 5 100 42 > ../data/txts/grafo.txt
...
signed main(signed argc, char **argv) {
    ...
    for(int i = 1; i <= n; i++) {
        for(int j: adj[i]) {
            cout << i << " " << j << " " << random_integer(100, max_weight) << endl;
        }
    }
